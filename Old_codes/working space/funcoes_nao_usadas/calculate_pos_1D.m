% CALCULATE_POS_1D --> Calcula a posição de um evento entre 2 microfone
%
% Sintaxe:
%   calculate_pos_1D(audio_data1, audio_data2, start_idx, end_idx, Fs, v)
%   
% Entradas:
...
function pos_sound = calculate_pos_1D(audio_data1, audio_data2, start_idx, end_idx, Fs, v)
