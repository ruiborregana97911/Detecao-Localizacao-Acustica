...
% versao com detecao de ultrason
% 
%
...
%                             ultra_flag=ultrasonic_comp(data1,Fs);
%                             
%                             if ultra_flag==false
...
%                             end
                            ...
                            [pos_s, c2, lags2]=calculate_pos_1D_v3(data1, data2, Fs, v, smp_dev);    %cuidado fiz alteracoe de posicao de data e colocquei um -!!!!!
                        else
...
%                             %detecao da componente ultrasonica
%                             ultra_flag=ultrasonic_comp(data2,Fs);
%                             
%                             if ultra_flag==false
%                                 disp('detecao ignorada por falta de componente ultrasonica');
%                                 continue
