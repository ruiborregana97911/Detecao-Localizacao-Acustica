...
% estou por vezes a perder informacao tentar resolver isso, ate agora esta
% versao é a melhor no que toca a encquadramento do sinal de analise! 
%
%
...
tmp_analise = 40;        % tempo de analise em ms
...
while p_time < op_time
    ...
    audio_data1=[audio_data1(257:end) frame_data(:, 1)'];
    audio_data2=[audio_data2(257:end) frame_data(:, 2)'];
    count= count+1;
    ...
    mean_Eng=[mean_Eng Eng_med1];   %debbuging
        ...
        elseif(skip_analysis==1)
            ...
            if(skip_count < (buffer_size/4)/frame_size)  %vou saltar iteracoes para poupar processamento e perdas de info e nao repetir analise de dados
